...
function InterpLightCloudy(Input1,Input2,Output1,Output2)
...
for FNo=1:SimLightDataRow
    ...
    MeasuredLight(:,1)=SimLightData(FNo,11:SimLightDataCol)'.*PPF_ratio;
...
for FNo=1:SimLightDataRow
if SimLightData(FNo,1)>=X1&&SimLightData(FNo,1)<X2&&SimLightData(FNo,2)>=Y1&&SimLightData(FNo,2)<Y2
MeasuredLight=SimLightData(FNo,11:SimLightDataCol)'.*PPF_ratio;
